...
atomsk --create bcc 2.8553122 Fe orient  [010]  [-101]   [101] \
-duplicate 14 14 3 \
-prop elastic.txt \
-disloc 0.501*box 0.251*box mixed z y 1.427656 0.0 -2.019011 \
-disloc 0.501*box 0.751*box mixed z y 1.427656 0.0 -2.019011 \
Fe_mixed.lmp
