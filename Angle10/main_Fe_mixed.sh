...
atomsk --create bcc 2.8553122 Fe orient [131] [-101] [3-23] \
-duplicate 34 34 1 \
-prop elastic.txt \
-disloc 0.501*box 0.251*box mixed z y 0.430455 0.0 2.435018 \
-disloc 0.501*box 0.751*box mixed z y 0.430455 0.0 2.435018 \
Fe_mixed.lmp
