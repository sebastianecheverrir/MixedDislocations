...
atomsk --create bcc 2.8553122 Fe orient [-12-1] [-101] [111] \
-duplicate 8 8 3 \
-prop elastic.txt \
-disloc 0.501*box 0.251*box mixed z y 2.33191 0.0 -0.8244 \
-disloc 0.501*box 0.751*box mixed z y 2.33191 0.0 -0.8244 \
Fe_mixed.lmp
